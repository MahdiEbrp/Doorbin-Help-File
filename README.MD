# Doorbin: A Comprehensive Guide

## Table of Contents
1. [Accessing the Doorbin](#1-accessing-the-doorbin)
...
## 1. Accessing the Doorbin
### Location:
![Doorbin Location](1.jpg)
...
![Doorbin Location](2.jpg)

### Accessing the Doorbin:
1. Hover over the "Products" menu in the sidebar.
2. Look for "Doorbin" in the submenu that appears.
...
## 2. Search Panel
![Doorbin Location](3.jpg)

### Overview 
The Search Panel provides comprehensive search functionality for Doorbins, allowing users to filter and locate specific log entries using multiple criteria.
...
### Accessing the Panel
- Located within the Doorbin plugin interface
...
### Accessing the Panel
- Located within the Doorbin plugin settings
- "Back" button returns you to the main Doorbin settings page
...
1. Doorbin plugin settings
2. Use the "Back" button to return to the main Doorbin settings
